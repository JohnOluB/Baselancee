        ...
        <Card className="w-full max-w-md text-center">
          <CardContent className="p-8">
            ...
            <CardDescription className="mt-2 text-muted-foreground">
              Welcome to BaseLance. You are being redirected to your
              dashboard...
            </CardDescription>
          </CardContent>
        </Card>
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-primary/5 via-background to-accent/5 p-4 sm:p-6 md:p-8">
      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl">Create your Client account</CardTitle>
          <CardDescription className="pt-2">
            Start hiring top talent on BaseLance.
          </CardDescription>
        </CardHeader>
        <CardContent>
