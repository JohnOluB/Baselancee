  ...
  const recommendedJobs = [
    {
      ...
      posted: "2h ago",
      description:
        "We are looking for an experienced frontend developer to join our team and help build the next generation of e-commerce experiences...",
      budget: "$80 - $120 / hr",
      type: "Hourly",
    ...
    },
    {
      ...
      posted: "5h ago",
      description:
        "Seeking a talented UI/UX designer to redesign our mobile application. You will be responsible for creating intuitive and visually appealing user interfaces.",
      budget: "$3,500",
      type: "Fixed Price",
    ...
    },
    {
      ...
      posted: "1d ago",
      description:
        "Join our DeFi team to build and maintain smart contracts for our new lending protocol. Experience with Solidity and EVM is required.",
      budget: "$150 / hr",
      type: "Hourly",
                  ...
                  <div className="flex text-yellow-400">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`h-4 w-4 ${
                          i < Math.floor(stat.rating) ? "fill-current" : ""
                        }`}
                      />
                    ))}
                  </div>
