...
const conversations = [
  {
    ...
    lastMessage: "Great progress! Let's schedule a call to discuss the next steps.",
    timestamp: '2h ago',
    unreadCount: 2,
    isOnline: true,
  },
  {
    ...
    lastMessage: "You: Thanks! I'll send the revision over by EOD.",
    timestamp: '5h ago',
    unreadCount: 0,
    isOnline: false,
  },
  {
    ...
    lastMessage: 'You: Proposal submitted. Please let me know if you have questions.',
    timestamp: '3d ago',
    unreadCount: 0,
    isOnline: false,
  },
...
const messages = [
    ...
    { type: 'client', from: 'TechCorp Inc.', content: "Hi John! Excited to start this project. Can we have a kickoff call sometime this week?", timestamp: 'Oct 10, 10:30 AM' },
    { type: 'freelancer', content: "Absolutely! I'm available tomorrow at 2 PM GMT. Does that work?", timestamp: 'Oct 10, 11:15 AM', read: true },
    { type: 'client', from: 'TechCorp Inc.', content: "Perfect! Here's the Zoom link: ...", timestamp: 'Oct 11, 9:00 AM' },
    { type: 'system', content: '💰 Milestone 1 payment released: 400 USDC' },
    { type: 'freelancer', content: "Here's the first deliverable for your review.", timestamp: 'Oct 12, 9:00 AM', read: true, attachment: { name: 'design-mockup-v2.fig', size: '2.4 MB' } },
    { type: 'client', from: 'TechCorp Inc.', content: "Great progress! Let's schedule a call to discuss the next steps.", timestamp: '2h ago' },
    { type: 'client', from: 'TechCorp Inc.', isTyping: true },
];
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
               {messages.map((msg, index) => {
                    ...
                    if (msg.from === 'TechCorp Inc.' && msg.isTyping) {
                        return (
