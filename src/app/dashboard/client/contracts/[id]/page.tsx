        ...
        <div className="space-y-6">
            <header>
                 <div className="text-sm text-muted-foreground flex items-center gap-2 mb-2">
                    <Link href="/dashboard/client/contracts" className="hover:text-primary">Contracts</Link>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                         ...
                         <Button variant="outline" asChild>
                             <Link href={`/dashboard/client/contracts/${contract.id}/manage`}>Manage Contract</Link>
                         </Button>
                         <Button asChild>
                         ...
                         <Button variant="destructive" outline>Report Issue</Button>
                                ...
                                <Card key={i} className="p-4">
                                     <div className="grid md:grid-cols-[1fr_auto_auto] gap-4 items-center">
                                        ...
                                        <div className="flex items-center gap-2 justify-end">
                                            ...
                                            {milestone.status === 'In Review' && <Button>Approve</Button>}
                                            {milestone.status === 'Pending' && <span className="text-sm text-muted-foreground">Awaiting submission</span>}
                                        </div>
                                     </div>
                                </Card>
                           ))}
                 ...
                 <aside className="lg:col-span-1 sticky top-24 space-y-6">
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            ...
                            <p className="text-xs text-muted-foreground pt-2">Platform Fee: ${contract.paymentSummary.platformFee.toLocaleString()} USDC</p>
                            <Button className="w-full mt-4">Release Payment</Button>
                        </CardContent>
                    </Card>
                    <Card>
